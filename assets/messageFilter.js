window.addEventListener('DOMContentLoaded', () => {
    ...
    let active = document.getElementsByClassName("message-active") ;
    let all = document.getElementsByClassName("message-row");
    let desactive = document.getElementsByClassName("message-inactive");
